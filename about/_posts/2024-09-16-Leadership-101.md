...
One thing that will remain unchanged is my consulting-like motto as a freelancer: I will always try to make myself redundant, I will always remove myself from any situation where I (no longer) can add value. This doesn't mean I will try to abandon the team as soon as possible, no, on the contrary. It means that I will always try to make sure that in any output of the team, there is not a single dependency involving "me".
