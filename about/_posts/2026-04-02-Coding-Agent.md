---
title: "Coding Agent & LLM Collaboration"
full_title: "How I Use a Coding Agent and LLM for This Site"
tags:
  - thing
  - personal
  - agentic
...
prompt: Create a new page in the "About" section that explains how I, the site owner, use a coding agent and an LLM for various maintenance tasks.  Every commit involving a coding agent will have an attribution in the commit message.  Unless otherwise noted, all content on the site is original content by me.  When a page is created by a coding agent, it will have a banner stating this, along with the prompt used to create it.  Keep it fun and appealing, consistent with the overall spirit of the website.
---
...
**Commit Attribution**: Every commit that involved the coding agent includes a clear attribution in the commit message. You can check the [git history](https://github.com/christophevg/christophe.vg/commits/master) to see exactly what was done with AI assistance.
...
1. **Honesty**: I believe in being upfront about how things are made. If a page was generated with AI help, you should know.

2. **Credit where due**: The coding agent does real work. But it's work directed by me, reviewed by me, and approved by me. The final say is always human.

3. **Learning opportunity**: By sharing the prompts, you can see how I work with the coding agent. Maybe you'll pick up some ideas for your own workflow.

4. **Quality control**: Being transparent keeps me accountable. I'm putting my name on this site, and I want you to trust that the content is accurate and genuine.
