...
That tenet comes at a cost. I could have simply downloaded one of the many readily available sets of Claude Code skills and agents and followed the instructions of the online big shot social media voices. I'd probably would have wonderful stories to tell as of day one. Carving out 8 hours a day, 5 days a week for (so far 4 months), is quiet an investment. On the other hand, I'm not quiet ready to stop working yet, which makes a 3% investment in my beloved profession more than acceptable, especially if the potential return is magnitudes bigger. And if it turned out to be useless (unlikely, but hey, you never know, I've dismissed other promising technologies before) the cost would also be worth that knowledge.
...
Although I've kept a lot of screenshots and transcripts of those first days and weeks, I can't seem to find the one where out of the blue, an agents described itself as a "very capable intern". Eight references to this phrase on this site, and counting, prove that it struck a nerve. Up to now, I haven't found a better way to describe these new found coworkers: very capable interns.
...
What you have come to know as AI these days, through the likes of ChatGPT, Claude, Gemini, Copilot..., are all incarnations of only a small part of AI, yet one that has taken the AI scene by storm, due to its incredible end-user opportunities: the large language model, LLM in short. In part 2 I'll compare it to the central processing unit of your computers, the CPU, the engine. You put things in and things come out. And in the case of an LLLM, things are no longer ones and zeros, or complicated programming languages, but simply human language.
...
{% include external link="https://github.com/christophevg/pypi-template" title="PyPi Template" %} was my solution to setting up and managing the many Python-based projects I started around 2018. I needed a way to quickly set up a project the way I liked and make sure it was consistent across all the projects I was maintaining, enabling me to upgrade all of them if something changed to my preferred setup. I has served me well. And pretty much like with Baseweb, over the past 8 years, there have emerged a lot of great, read: much better, solutions, but reviewing them, selecting one and then applying it across all my projects as another renovation project of enormous proportions.

These are just two examples of projects that we're grinding in the sand, collecting proverbial dust, not dramatic, it's all just personal stuff, no one was dying, simply a slow stagnation, a slow fade into irrelevance. The mountain of technical debt was too steep to climb alone, and the only way to deal with it at the beginning of 2026, as to be slightly frustrated. Being used to working with a team, where was _my personal_ team when I needed it most?
...
I told you before, the human _has to_ remain in the driver seat and has to keep taking up his/her responsibility. Agents can't replace us in the general picture, probability only makes them creative by chance. We are able to always be creative, by intention. This same coin has another side: if we make a mistake, or at least a certain category of mistakes, the agent will happily push the button that launches the nuclear missile, with a smile and "You're absolutely right!"
...
The experiment did stop there. With its name and persona active, I also asked it to create a prompt for creating an image of itself. The prompt that it created was:
...
Okay, let's get one elephant our of the room right away: Yes, this is all _very_ cheesy, yet also a bit scary, how "simple" probability produces human emotion-like behaviour.
