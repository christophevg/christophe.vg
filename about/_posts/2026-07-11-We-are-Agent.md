...
> "Success is not built on success. It's built on failure. It's built on frustration. Sometimes it's built on catastrophe." - {% include external link="https://www.goodreads.com/quotes/7668253-success-is-not-built-on-success-it-s-built-on-failure" title="Sumnor Redstone" %}
