...
tags: veggie
recipe:
  intro: "Een verrassend lekkere Amerikaanse klassieker!"
  ingredients:
    - "Voor de bodem:"
    - "320g bloem"
    - "1 theelepel zout"
  ...
  instructions:
    - "Meng bloem, zout en suiker. Doe samen met de boter in een keukenrobot met messen. Hak alle ingrediënten kort tot je een grof meel bekomt."
    ...
    - "Meng ongeveer 200g van de pudding met de chocolade en laat afkoelen. Bedek hiermee de bodem van de taart. Laat de bodem met de donkere \"bottom\" nu afkoelen in de koelkast."
    ...
    - "Klop de room stijf, strijk over de taart en werk af met chocolade krullen. Zet in de koelkast tot opdienen."
---