...
tags: veggie
recipe:
  intro: "Ik ben geen \"snoeper\", maar voor de kids maak ik wel eens een uitzondering ;-)"
  ingredients:
    ...
    - "2 el esdoornsiroop"
  instructions:
    - "Meng alle ingrediënten, behalve de witte chocolade in een pan en zet op een zacht vuurtje. Roer tot de massa van textuur verandert - dit is wanneer de suiker begint te karameliseren - ongeveer rond 110 graden celcius."
