...
recipe:
  intro: "Ondanks alles kan je Amerikanen één ding niet ontzeggen: appreciatie voor hun sauzen. Deze variatie op de klassieke mayonaise is werkelijk heerlijk. We hebben onze versie getest op ons Haute Dog Buffet en het was een regelrechte hit."
  ingredients:
    - "1 eidooier"
    - "1 teentje look, fijn"
