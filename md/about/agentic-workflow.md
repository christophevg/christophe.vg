...
URL: https://christophe.vg/about/agentic-workflow/

A concise reference for how I work with AI agents. For the full narrative, see the three-part article series linked at the bottom.

## The Short Version

I employ agents as capable collaborators who execute my ideas more swiftly than I can type them. They possess an extensive knowledge base and can query Google faster than I can. They never tire. I can continuously request modifications, alternatives and one-off experiments. They keep presenting me with options to choose from.

While I grant them significant autonomy, I've implemented a growing set of guardrails, both technical and in person. I always review the results and, if they differ from my preferred approach, I demand clarifications and engage in discussions until we reach a consensus. The final product still bears my name and reflects my endorsement. One crucial principle has been the key to this success story: letting go of many of my old, dogmatic beliefs.
...
My agents and their skills are open-source ([C3 on GitHub](https://github.com/christophevg/c3)), and every commit on GitHub is clearly attributed. I've created a [separate GitHub account](https://github.com/christophevg-agent) specifically for the agents to commit and push their work. My agents and I also utilize feature branches and pull requests to enable me to validate their work with a publicly accessible trail.

On this website, unless explicitly stated, all content is original. When AI assistance is involved, it is clearly indicated, including the "prompt" used to generate it. See [Coding Agent & LLM Collaboration](https://christophe.vg/about/coding-agent/) for more details.

## The Full Story

1. [Hello Agents](https://christophe.vg/about/hello-agents/): The initial encounter and impact. The first law.
2. [We are Agent](https://christophe.vg/about/we-are-agent/): The mechanics: components, governance, and guardrails. The second law.
3. [Dawn of the Agents](https://christophe.vg/about/dawn-of-the-agents/): The broader implications for the future of work. The third law.
