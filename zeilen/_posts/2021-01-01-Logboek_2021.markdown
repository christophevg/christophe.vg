...
thumbs:
  files:
    tour-du-zoute:
      title: Tour du Zoute
    fin-de-saison-en-noir:
      title: Fin de saison en noire
    two-friends-on-the-beach:
      title: Two friends on the beach
    papys-race-3:
      title: Zeebrugge zonsondergang
    papys-race-2:
      title: Boosui up close & personal
    papys-race-1:
      title: Boosui up close & personal
    kids-sessie-2-3:
      title: 3 VGs sailing
    ...
    kids-sessie-2-1:
      title: pre sessie 2
    kids-sessie-1-2:
      title: geconcentreerd
    kids-sessie-1-1:
      title: pre sessie 1
    post-zwin-race:
      title: post zwin race
    bijna-bijna:
      title: bijna ... bijna
    zeilstage-dag-1:
      title: zeilstage dag 1
    zomer-voorbereiden:
      title: zomer voorbereiden
    opruimen-klaarmaken:
      title: opruimen en klaarmaken
    look-whos-back:
      title: look who's back
    diy-sleepdienst:
      title: DIY sleepdienst
...
{% include thumbs show="two-friends-on-the-beach,fin-de-saison-en-noir,tour-du-zoute" %}
...
{% include thumbs show="papys-race-1,papys-race-2,papys-race-3" %}
...
{% include thumbs show="kids-sessie-2-1,kids-sessie-2-2,kids-sessie-2-3" %}
...
{% include thumbs show="kids-sessie-1-1,kids-sessie-1-2" %}
...
{% include thumbs show="post-zwin-race" %}
...
{% include thumbs show="zeilstage-dag-1,bijna-bijna" %}
...
{% include thumbs show="zomer-voorbereiden" %}
...
{% include thumbs show="opruimen-klaarmaken" %}
...
Wanneer we op zoek gaan naar L'Aperçu, de winkel van {% include external link="https://www.catacare.be" title="Catacare" %} in Duinbergen, ontdek ik dat er op 500m van de RBSC beach club, een nieuwe beach club is: {% include external link="https://www.anemos.be" title="Anemos" %}.

## 23 mei - Boosui is back bitches

{% include thumbs show="goodmorning-sunshine,diy-sleepdienst,look-whos-back" %}
...
{% include thumbs show="coming-home" %}
