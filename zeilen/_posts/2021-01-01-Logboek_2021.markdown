...
{% include image name="tour-du-zoute" title="Tour du Zoute" %}

{% include image name="fin-de-saison-en-noir" title="Fin de saison en noire" %}

{% include image name="two-friends-on-the-beach" title="Two friends on the beach" %}
